...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["Kotlin", "Android Studio", "Retrofit2", "OKHTTP3", "Glide", "Hilt", "Spring Boot", "MySQL", "Firebase", "JWT", "Spring Security"],
    ...
    },
    {
      ...
      tech: ["React.js", "TypeScript", "SpringBoot", "SpringSecurity", "Hibernate", "FastAPI", "PostgreSQL", "Redis"],
      features: ["소비 데이터 분석 및 금융 습관 시각화", "맞춤형 금융 교육 콘텐츠 제공", "개인 소비 패턴 분석 및 학습 방향 제안", "금융 배틀 및 고양이 캐릭터 수집 게이미피케이션"],
      techReason:
        "프론트엔드는 사용자 인터페이스의 복잡성과 상태 관리를 위해 React.js와 TypeScript를 사용했습니다. 백엔드는 안정적인 API와 확장성을 고려하여 SpringBoot와 SpringSecurity로 구현하였고, 일부 데이터 처리 기능은 FastAPI를 통해 빠른 응답 속도를 보장했습니다. 데이터베이스는 안정적인 관계형 데이터 저장을 위해 PostgreSQL을 사용하고, 캐싱과 실시간 처리를 위해 Redis를 도입했습니다. Hibernate는 객체 관계 매핑을 통해 데이터베이스 작업을 단순화하는 데 큰 역할을 했습니다.",
    ...
    },
    {
      ...
      description:
        "비컨 기업과 연계된 프로젝트로, 사용자의 얼굴형을 분석하여 최적의 헤어스타일을 추천하는 웹 애플리케이션입니다. 머신러닝 모델을 활용해 정확한 얼굴형 분석과 개인화된 추천 서비스를 제공합니다.",
      image: "./assets/backgroud.jpg",
      tech: ["React.js", "Spring Boot", "OpenCV", "AWS", "PostgreSQL"],
      features: ["얼굴형 실시간 분석", "개인화된 헤어스타일 추천", "가상 헤어스타일 시뮬레이션", "전문 스타일리스트 연결 서비스"],
      techReason:
